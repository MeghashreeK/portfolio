...
const ContactMe = () => {
  return (
    <div className='flex flex-col h-screen bg-[#010B13] mt-5 gap-6 sm:gap-5'>
        <h1 className='font-bold text-4xl font-Merriweather'>Contact me</h1>

        <div className='flex justify-center mx-2 items-center h-full text-[14px] sm:text-[16px] font-Montserrat'>
    <div className='flex flex-col gap-4 bg-[#1E293B] rounded-lg text-white p-6 shadow-lg'>
        ...
        <div className='flex items-center gap-2 rounded-lg p-3'>
            ...
            <p className='text-yellow-400'>kundermeghashree279@gmail.com</p>
        </div>
